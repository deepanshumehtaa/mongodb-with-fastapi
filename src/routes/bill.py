...
@bill_router.get("/bill", tags=["bill"], dependencies=[Depends(auth.login_required)])
async def list_bill(
...
@bill_router.get("/bill/statistic", tags=["bill"], dependencies=[Depends(auth.login_required)])
...
@bill_router.post("/bill", tags=["bill"], dependencies=[Depends(auth.login_required)])
...
@bill_router.delete("/bill/{bill_id}", tags=["bill"], dependencies=[Depends(auth.login_required)])
...
@bill_router.get("/bill/export", tags=["bill"], dependencies=[Depends(auth.login_required)])
