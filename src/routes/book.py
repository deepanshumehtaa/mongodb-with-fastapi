...
@book_router.post("/book", tags=["book"], dependencies=[Depends(auth.login_required)])
...
@book_router.put("/book/{book_id}", tags=["book"], dependencies=[Depends(auth.login_required)])
...
@book_router.delete("/book/{book_id}", tags=["book"], dependencies=[Depends(auth.login_required)])
